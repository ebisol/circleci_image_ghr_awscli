...
RUN go get go get github.com/labstack/echo
RUN go get go get github.com/mattn/go-colorable
RUN go get gopkg.in/pp.v2
RUN go get gopkg.in/redis.v3
RUN go get gopkg.in/tylerb/graceful.v1
...
RUN pip3 install -U requests setuptools tox
