...
RUN sudo npm install -g serverless@1.26.1 eslint@4.19.1 eslint-config-standard eslint-plugin-standard eslint-plugin-promise eslint-plugin-import eslint-plugin-node
